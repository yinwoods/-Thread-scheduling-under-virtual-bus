...
build_time_vars = {'ABIFLAGS': 'dm',
 ...
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -g -O0 -Wall -Wstrict-prototypes -g -O0 '
           '-fstack-protector --param=ssp-buffer-size=4 -Wformat '
           '-Werror=format-security  -g -O0 -fstack-protector '
           '--param=ssp-buffer-size=4 -Wformat -Werror=format-security',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-g -O0 -fstack-protector --param=ssp-buffer-size=4 '
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-ipv6' "
                ...
                "'--with-fpectl' '--enable-shared' '--with-pydebug' "
                "'CC=x86_64-linux-gnu-gcc' 'CFLAGS=-g -O0 -fstack-protector "
                "--param=ssp-buffer-size=4 -Wformat -Werror=format-security' "
                "'LDFLAGS=-Wl,-Bsymbolic-functions -Wl,-z,relro' "
                "'CPPFLAGS=-D_FORTIFY_SOURCE=2'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.4dm',
 'COREPYTHONPATH': ':plat-x86_64-linux-gnu',
 'COVERAGE_INFO': '/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug/coverage.info',
 'COVERAGE_REPORT': '/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug/lcov-report',
 ...
 'INCLDIRSTOMAKE': '/usr/include /usr/include /usr/include/python3.4dm '
                   '/usr/include/python3.4dm',
 'INCLUDEDIR': '/usr/include',
 'INCLUDEPY': '/usr/include/python3.4dm',
 'INSTALL': '/usr/bin/install -c',
 'INSTALL_DATA': '/usr/bin/install -c -m 644',
 'INSTALL_PROGRAM': '/usr/bin/install -c',
 'INSTALL_SCRIPT': '/usr/bin/install -c',
 'INSTALL_SHARED': '/usr/bin/install -c -m 555',
 'INSTSONAME': 'libpython3.4dm.so.1.0',
 ...
 'LIBPL': '/usr/lib/python3.4/config-3.4dm-x86_64-linux-gnu',
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-Wno-unused-result -g -O0 -Wall -Wstrict-prototypes -g -O0 '
              '-fstack-protector --param=ssp-buffer-size=4 -Wformat '
              '-Werror=format-security  -g -O0 -fstack-protector '
              '--param=ssp-buffer-size=4 -Wformat -Werror=format-security',
 'PY_CFLAGS_NODIST': '-Werror=declaration-after-statement',
 'PY_CORE_CFLAGS': '-Wno-unused-result -g -O0 -Wall -Wstrict-prototypes -g '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug '
 ...
 'abs_builddir': '/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug',
 'abs_srcdir': '/build/python3.4-eNHHUi/python3.4-3.4.3/build-shdebug/..',
